...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_65_ansi(
        ...
        MT(MOD_LGUI,KC_TAB), KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, KC_BSLS, KC_PGUP,
    ...
    [1] = LAYOUT_65_ansi(
        ...
        _______,             _______, _______, _______, RM_TOGG, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
